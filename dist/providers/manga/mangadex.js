    ...
    constructor() {
        ...
        this.fetchMangaInfo = async (mangaId, languages) => {
            ...
            try {
                ...
                const coverArt = (findCoverArt === null || findCoverArt === void 0 ? void 0 : findCoverArt.id) ? await this.fetchCoverImage(findCoverArt === null || findCoverArt === void 0 ? void 0 : findCoverArt.id) : null;
            ...
            try {
                ...
                if (res.data.result == 'ok') {
                    ...
                    for (const manga of res.data.data) {
                        ...
                        const coverArt = (findCoverArt === null || findCoverArt === void 0 ? void 0 : findCoverArt.id) ? await this.fetchCoverImage(findCoverArt === null || findCoverArt === void 0 ? void 0 : findCoverArt.id) : '';
